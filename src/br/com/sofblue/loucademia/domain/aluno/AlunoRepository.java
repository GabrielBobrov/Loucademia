...
public class AlunoRepository {
	...
	public List<Acesso> listAcessosAlunos(String matricula, LocalDate dataInicial, LocalDate dataFinal){
		...
		if(dataInicial != null) {
			LocalDateTime ldt = LocalDateTime.of(dataInicial, LocalTime.of(0, 0));//convertendo localdate para localdatetime
		...
		if(dataFinal != null) {
			...
			LocalDateTime ldt = LocalDateTime.of(dataFinal, LocalTime.of(23,59,59));//convertendo localdate para localdatetime
